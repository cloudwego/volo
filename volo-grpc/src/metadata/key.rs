//! These codes are copied from `tonic/src/metadata/key.rs` and may be modified by us.

use std::{borrow::Borrow, error::Error, fmt, marker::PhantomData, str::FromStr};
...
///
/// `MetadataKey` is used as the [`WrappedHeaderMap`] key.
///
/// [`HeaderMap`]: struct.HeaderMap.html
/// [`WrappedHeaderMap`]: struct.WrappedHeaderMap.html
